...
stock_tags 작성 규칙:
- 한국거래소 상장 종목은 반드시 6자리 종목코드를 포함 (예: "005930:삼성전자", "000660:SK하이닉스")
- 코드를 특정할 수 없는 경우 이름만 사용 (예: "반도체섹터", "2차전지")
- 직접 영향받는 종목 위주로 최대 5개
- direction: 이 뉴스가 stock_tags의 종목에 호재(positive)인지 악재(negative)인지, 불분명하면 neutral"""
